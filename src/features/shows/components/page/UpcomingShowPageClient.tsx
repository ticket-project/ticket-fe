...
interface UpcomingShowPageClientProps {
  categoryCode: CategoryCode;
  categorySlug: CategorySlug;
}

const UpcomingShowPageClient = ({
  categoryCode,
  categorySlug,
}: UpcomingShowPageClientProps) => {
  const { filters, setRegion, setSort } = useShowsFilter();
  const query = useUpcomingShowsInfinite(categoryCode, filters);
...
export default UpcomingShowPageClient;
